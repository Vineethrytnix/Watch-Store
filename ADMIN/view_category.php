...
<br>
                            <a href="add_products.php?c_id=<?php echo $row['c_id'] ?>" class="btn btn-outline-dark" style="border-radius:10px">Add products</a><br><br>
                           <p><a href="delete_category.php?cid=<?php echo $row['c_id'] ?>" class="genric-btn primary-border small" style="border-radius:3px">Delete</a></p>
                        </div>
                    </div>
                </div>
