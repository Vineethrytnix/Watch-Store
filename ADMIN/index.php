                                ...
                                <ul id="navigation">
                                    ...
                                    <li><a href="">View</a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="view_bookings.php"> Orders</a></li>
                                    ...
                                    <li><a href="">Add</a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="add_products.php"> Product</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="view_users.php"><span class="flaticon-user"></span> User</a></li>
                                    <li><a href="view_service_centres.php"><img src="../assets/img/customer-support.png"
                                                width="25px" alt=""> Service Centre</a></li>
                                    ...
                                    <li><a href="../login.php"><img src="./../assets/img/switch.png" width="30px"
                                                alt="">
                                        </a></li>
                                </ul>
                            </nav>
