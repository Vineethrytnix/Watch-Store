...
if (isset($_REQUEST['submit'])) {
    ...
    $update = "UPDATE `service_booking` SET `payment`='Paid',`status`='Payment & Service Completed' WHERE `sc_id`='$sb_id' AND `uid`='$uid'";

    if ($conn->query($update) == TRUE) {
        echo "<script>alert('Payment Successfully Paid'); window.location = 'view_booked_service.php';</script>";
    } else {
