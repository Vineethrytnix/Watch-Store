            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href=""><img src="../assets/img/hero/smart-watch.png" width="50px" alt="">Watch Store</a>
                        </div>
                        <!-- Main-menu -->
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="view_category.php">Watches</a></li>
                                    <!-- <li><a href="view_bookings.php">My Bookings</a></li> -->
                                    <li><a href="view_services.php">Services</a></li>
                                    <li><a href="#">View</a>
                                        <ul class="submenu">
                                            <li><a href="view_booked_service.php">Booked Services</a></li>
                                            <li><a href="view_bookings.php">My Orders</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <!-- <li><a href="../login.php"><img src="./../assets/img/switch.png" width="30px" alt="">
                                            Logout</a></li> -->
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li> <a href="../login.php"><img src="./../assets/img/logout.png" width="18px" alt=""></a></li>
                                <li><a href="view_cart.php"><span class="flaticon-shopping-cart"></span></a> </li>
                            </ul>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular1.png" id="img" alt="">
                                <div class="img-cap">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular2.png" id="img" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular3.png" id="img" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular4.png" id="img" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular5.png" id="img" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../assets/img/gallery/popular6.png" id="img" alt="">
                                <div class="img-cap">
                                    <span>Add to cart</span>
                                </div>
                                <div class="favorit-items">
