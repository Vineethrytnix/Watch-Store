...
if (isset($_REQUEST['submit'])) {
    ...
    $insert = "INSERT INTO `payment`(`uid`,`amount`,`date`,`time`)VALUES('$uid','$amt','$formattedDate','$current_time')";
    $update = "UPDATE `cart` SET `status`='Purchased' WHERE `uid`='$uid'";

    if ($conn->query($update) == TRUE && $conn->query($insert) == TRUE) {
        echo "<script>alert('Payment Successfully Paid'); window.location = 'view_cart.php';</script>";
    } else {
