                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="service_centre.php"><img src="./assets/img/customer-support.png"
                                                width="25px" alt=""> Service Centre</a></li>
                                    <li><a href="user_reg.php"><span class="flaticon-user"></span> User</a></li>
                                    ...
                                    <li><a href="login.php"><img src="./assets/img/arrow.png" width="30px" alt="">
                                            Login</a></li>
                                </ul>
                            </nav>
                        </div>
